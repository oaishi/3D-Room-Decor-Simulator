...
public class Server {
     ...
     public static void main(String args[]) throws Exception {
        ...
        BufferedReader bir = new BufferedReader(new FileReader(sush + "\\src\\TextContent\\sources.txt"));
         while(true){
                     ...
                     if(source.equals("wallpaper"))
                     {
                         wp++;
                         i=wp;
                         BufferedWriter biw = new BufferedWriter(new FileWriter(sush + "\\src\\TextContent\\file_version.txt"));
                         biw.write( wp + "-" + tl );
                         biw.close();
                     }
    ...
    private static void downloadImage(String imgSrc , String demo ,int i) throws IOException {
        ...
        try {
            ...
            String url = null;
            url = imgSrc;
            imgPath = s + "/" + "src" + "/BinaryContent/" + demo + "/" + i + "." + imageFormat + "" ; 
